...
public class MusicDriver {
    public static void main(String[] args) throws Exception {
        // Instantiate a default Hadoop configuration.
        Configuration conf = new Configuration();
        // Creates a new Job object tied to your conf
        // The second argument is a human-readable job name, visible in the Hadoop UI.
